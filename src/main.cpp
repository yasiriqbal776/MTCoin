...
uint256 hashGenesisBlock("0x06c70ed3545871804326af83b712b08713458febc8385340a9a2314db6dd1949");
...
static const int64 nTargetSpacing = 1.5 * 60; // Litecoin: 1.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x06c70ed3545871804326af83b712b08713458febc8385340a9a2314db6dd1949");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "NY Times 03/Dec/2017 Taha Qazi, MTCoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 10500 * COIN;
        ...
        block.nVersion = 1;
        block.nTime    = 1512247372;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1001276;
        ...
        assert(block.hashMerkleRoot == uint256("0x16a0d858af928785c2043f2d436a301dcfe717211bc18d16ccc5ba66d710c29a"));
